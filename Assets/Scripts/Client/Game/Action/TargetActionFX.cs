...
namespace Client.Game.Action
{
    ...
    public class TargetActionFX : ActionFX
    {
        ...
        public override bool Start()
        {
            ...
            m_ParentState.GetComponent<ClientInputSender>().ActionInputEvent += OnActionInput;
        ...
        public override void Cancel()
        {
            ...
            m_ParentState.TargetId.OnValueChanged -= OnTargetChanged;
            if( m_ParentState.TryGetComponent(out ClientInputSender inputSender))
            {
